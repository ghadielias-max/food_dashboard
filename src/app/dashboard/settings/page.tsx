...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-8 bg-background min-h-screen">
      ...
      <div className="bg-surface border border-primary-dark/20 rounded-2xl p-6 shadow-lg opacity-50 pointer-events-none filter grayscale">
        ...
        <div className="space-y-4">
          <div className="h-10 bg-background rounded-lg w-full" />
          <div className="h-10 bg-background rounded-lg w-2/3" />
        </div>
      </div>
    </div>
  );
