    ...
    <div className="space-y-8 bg-background min-h-screen">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={isLoading}
          className="px-4 py-2 bg-primary hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl text-sm font-medium transition-colors shadow-[0_0_15px_-3px_var(--color-primary)] flex items-center gap-2"
        >
          <svg
